...
class Thought:
    ...
    def __eq__(self, value):
        return type(value) == Thought and self.user_id == value.user_id and self.timestamp == value.timestamp and self.thought == value.thought
    def serialize(self):
        ...
        return user_id_bytes + timestamp_bytes + thought_length_bytes + thought_bytes
